...
export const WEB_PACKAGE_NAME = '@vercel/workflow-web';
...
/**
 * Get the path to the @vercel/workflow-web package
 ...
 *   test-project/node_modules/@vercel/workflow-cli/node_modules/@vercel/workflow-web
 */
function getWebPackagePath(): string {
  try {
    ...
    // Resolve the package.json of @vercel/workflow-web from the CLI's location
...
function envToQueryParams(
  ...
  const envToQueryParamMappings: Record<string, string> = {
    ...
    WORKFLOW_VERCEL_PROJECT_ID: 'project',
    WORKFLOW_VERCEL_TEAM_ID: 'team',
    PORT: 'port',
