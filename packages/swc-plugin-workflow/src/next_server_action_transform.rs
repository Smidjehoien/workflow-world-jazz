// This is a copy of the nextjs server actions transform. It's not included
// in the plugin, just here for reference so cursor can refer to it easily
// for writing the step transform.
