...
```bash
npm install @vercel/workflow-world-postgres
# or
pnpm add @vercel/workflow-world-postgres
# or
yarn add @vercel/workflow-world-postgres
```
...
```bash
export WORKFLOW_TARGET_WORLD="@vercel/workflow-world-postgres"
```
...
```typescript
import { createWorld } from "@vercel/workflow-world-postgres";
...
| -------------------------------------- | ------------------------------------------------------------ | ----------------------------------------------- |
| `WORKFLOW_TARGET_WORLD`                | Set to `"@vercel/workflow-world-postgres"` to use this world | -                                               |
