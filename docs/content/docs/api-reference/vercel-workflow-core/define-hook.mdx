...
This is a lightweight wrapper around [`createHook()`](/docs/api-reference/vercel-workflow-core/create-hook) and [`resumeHook()`](/docs/api-reference/vercel-workflow-core/resume-hook) to avoid type mismatches.
...
```ts lineNumbers
import { defineHook } from "@vercel/workflow-core"; 
...
* [`createHook()`](/docs/api-reference/vercel-workflow-core/create-hook) - Create a hook in a workflow.
* [`resumeHook()`](/docs/api-reference/vercel-workflow-core/resume-hook) - Resume a hook with a payload.
