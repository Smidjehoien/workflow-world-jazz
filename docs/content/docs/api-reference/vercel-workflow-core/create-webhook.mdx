...
```ts lineNumbers
import { createWebhook } from "@vercel/workflow-core"
...
```typescript lineNumbers
import { createWebhook, type RequestWithResponse } from "@vercel/workflow-core"
...
```typescript lineNumbers
import { type RequestWithResponse } from "@vercel/workflow-core"
...
- [`createHook()`](/docs/api-reference/vercel-workflow-core/create-hook) - Lower-level hook primitive for arbitrary payloads
- [`defineHook()`](/docs/api-reference/vercel-workflow-core/define-hook) - Type-safe hook helper
- [`resumeWebhook()`](/docs/api-reference/vercel-workflow-core/resume-webhook) - Resume a webhook from an API route
