...
```ts lineNumbers
import { createHook } from "@vercel/workflow-core"
...
definition={generateDefinition({
  code: `
import type { HookOptions } from "@vercel/workflow-core";
...
definition={generateDefinition({
  code: `
import type { Hook } from "@vercel/workflow-core";
export default Hook;`
})}
/>
...
- [`createWebhook()`](/docs/api-reference/vercel-workflow-core/create-webhook) - Higher-level HTTP webhook abstraction
