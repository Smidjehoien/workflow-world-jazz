...
The **Vercel World** (`@vercel/workflow-world-vercel`) is a production-ready workflow backend integrated with Vercel's infrastructure. It provides scalable storage, robust queuing, and secure authentication for workflow deployments on the Vercel platform.
...
4. Test locally first with [Embedded World](/docs/api-reference/world/world-embedded)

## Learn More

- [World Interface](/docs/api-reference/world) - Understanding the World interface
- [Embedded World](/docs/api-reference/world/world-embedded) - For local development
