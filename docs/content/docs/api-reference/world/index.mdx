...
The Workflow SDK provides two built-in world implementations:

- [Embedded World](/docs/api-reference/world/world-embedded) - Filesystem-based for local development
- [Vercel World](/docs/api-reference/world/world-vercel) - Production-ready for Vercel deployments
...
- [Vercel World](/docs/api-reference/world/world-vercel) - Production backend
