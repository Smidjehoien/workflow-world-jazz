...
- [`createWebhook()`](/docs/api-reference/vercel-workflow-core/create-webhook) - Create a webhook in a workflow
- [`resumeHook()`](/docs/api-reference/vercel-workflow-core/resume-hook) - Resume a hook with arbitrary payload
