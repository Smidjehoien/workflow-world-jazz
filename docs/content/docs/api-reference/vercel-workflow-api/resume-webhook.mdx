...
- [`createWebhook()`](/docs/api-reference/vercel-workflow/create-webhook) - Create a webhook in a workflow
- [`resumeHook()`](/docs/api-reference/vercel-workflow-api/resume-hook) - Resume a hook with arbitrary payload
