...
This is a lightweight wrapper around [`createHook()`](/docs/api-reference/vercel-workflow/create-hook) and [`resumeHook()`](/docs/api-reference/vercel-workflow-api/resume-hook) to avoid type mismatches.
...
* [`createHook()`](/docs/api-reference/vercel-workflow/create-hook) - Create a hook in a workflow.
* [`resumeHook()`](/docs/api-reference/vercel-workflow-api/resume-hook) - Resume a hook with a payload.
