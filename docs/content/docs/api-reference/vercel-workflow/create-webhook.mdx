...
- [`createHook()`](/docs/api-reference/vercel-workflow/create-hook) - Lower-level hook primitive for arbitrary payloads
- [`defineHook()`](/docs/api-reference/vercel-workflow/define-hook) - Type-safe hook helper
- [`resumeWebhook()`](/docs/api-reference/vercel-workflow-api/resume-webhook) - Resume a webhook from an API route
