...
- [createWebhook() API Reference](/docs/api-reference/vercel-workflow-core/create-webhook)
- [resumeWebhook() API Reference](/docs/api-reference/vercel-workflow-core/resume-webhook)
- [Webhooks Guide](/docs/how-it-works/hooks)
