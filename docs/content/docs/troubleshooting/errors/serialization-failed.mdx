...
Workflow supports these types across execution boundaries:
...
To learn more about supported types, see the [Serialization](/docs/how-it-works/workflow-functions#serialization) section.
...
3. **Ensure you are using supported data types** - see the [Serialization](/docs/how-it-works/workflow-functions#serialization) section for more details
