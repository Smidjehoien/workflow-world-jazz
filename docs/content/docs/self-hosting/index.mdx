...
<Cards>
  <Card title="Embedded World" href="/docs/self-hosting/world/world-embedded">
    Filesystem-based backend for local development. Stores data in `.workflow-data/` directory.
  </Card>
  <Card title="Vercel World" href="/docs/self-hosting/world/world-vercel">
...
See the [World API Reference](/docs/self-hosting/world) for implementation details.
...
- [Embedded World](/docs/self-hosting/world/world-embedded) - Local development backend
- [Vercel World](/docs/self-hosting/world/world-vercel) - Production backend for Vercel
- [World API Reference](/docs/self-hosting/world) - Building custom worlds
