...
<Callout type="warn">
  Self-hosting is currently in development.
</Callout>
...
Workflow ships with two world implementations:
...
On top of the default Worlds provided by Workflow, you can also build new world implementations for custom infrastructure:
