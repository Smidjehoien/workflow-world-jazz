...
For production deployments, use the [Vercel World](/docs/self-hosting/world/world-vercel).
...
- [World Interface](/docs/self-hosting/world) - Understanding the World interface
- [Vercel World](/docs/self-hosting/world/world-vercel) - For production deployments
