...
4. Test locally first with [Embedded World](/docs/self-hosting/world/world-embedded)

## Learn More

- [World Interface](/docs/self-hosting/world) - Understanding the World interface
- [Embedded World](/docs/self-hosting/world/world-embedded) - For local development
