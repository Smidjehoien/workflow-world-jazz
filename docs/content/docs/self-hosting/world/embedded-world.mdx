...
The embedded world provides a simple authentication implementation since no authentication is required or enforced in local development.
...
You can explicitly set the embedded world through environment variables:
