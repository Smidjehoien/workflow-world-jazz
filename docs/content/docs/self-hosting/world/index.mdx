...
<Callout type="warn">
  The World interface is currently in development.
</Callout>
...
```typescript
import type { World, Storage, Queue, AuthProvider, Streamer } from '@vercel/workflow-core';
...
Workflow provides two built-in world implementations:

- [Embedded World](/docs/self-hosting/world/world-embedded) - Filesystem-based for local development
- [Vercel World](/docs/self-hosting/world/world-vercel) - Production-ready for Vercel deployments

## Learn More

- [Self-Hosting](/docs/self-hosting) - Overview of worlds and backend configuration
- [Embedded World](/docs/self-hosting/world/world-embedded) - Local development backend
- [Vercel World](/docs/self-hosting/world/world-vercel) - Production backend
