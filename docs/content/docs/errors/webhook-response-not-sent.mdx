...
- [createWebhook() API Reference](/docs/api-reference/vercel-workflow/create-webhook)
- [resumeWebhook() API Reference](/docs/api-reference/vercel-workflow-api/resume-webhook)
