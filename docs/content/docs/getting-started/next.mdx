...
```json title="tsconfig.json" lineNumbers
{
  "compilerOptions": {
    ...
    "plugins": [
      {
        "name": "@vercel/workflow" // [!code highlight]
      }
    ]
  }
}
...
<Callout>
We'll dive deeper into workflows, steps, and other ways to suspend or handle events in [Concepts](/docs/foundations/concepts).
</Callout>
...
Additionally, you can use the [Workflow CLI](/docs/cli-reference) to inspect your workflow runs and steps in detail.
