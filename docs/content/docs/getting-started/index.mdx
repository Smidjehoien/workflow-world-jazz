...
<Callout>
Currently, Workflow works best with Next.js. We're actively working on improving support for other frameworks, including a standlone/framework-less mode.
</Callout>
...
<Cards>
    ...
    <Card href="/docs/getting-started/nitro" disabled className="flex flex-col items-center justify-center text-center gap-2">
