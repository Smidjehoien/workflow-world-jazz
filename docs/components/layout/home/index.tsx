  ...
  return (
    <NavProvider transparentMode={nav?.transparentMode}>
      <main
        id="nd-home-layout"
        {...rest}
        className={cn('flex flex-1 flex-col pt-20', rest.className)}
      >
        {nav.enabled !== false &&
          (nav.component ?? (
            <Header
        ...
        {props.children}
        <Separator className="mx-auto w-full max-w-7xl bg-gradient-to-r from-transparent via-border to-transparent" />
        <footer className="flex flex-col border-t p-8 w-full gap-8 sm:px-16 max-w-[1400px] mx-auto">
...
function SidebarToggle() {
  ...
  return (
    <button
      className="inline-flex items-center justify-center p-2 rounded-md text-fd-muted-foreground hover:opacity-60 transition-opacity md:hidden"
    ...
    <>
      <Navbar>
        <div className="flex items-center gap-2">
          ...
          <div className="w-4 text-lg text-center text-muted-foreground/25">
            <svg
        ...
        <div className="flex flex-row items-center justify-end gap-2 flex-1 max-lg:hidden">
          {searchToggle.enabled !== false &&
            (searchToggle.components?.lg ?? (
              <LargeSearchToggle
                className="w-full rounded-md ps-3 max-w-[172px]"
                hideIfDisabled
              />
            ))}
        ...
        <ul className="flex flex-row items-center gap-3 ms-auto lg:hidden">
          {searchToggle.enabled !== false &&
          ...
          <Menu>
            <MenuTrigger
              ...
              className={cn(
                ...
                '!bg-transparent !p-2 text-fd-muted-foreground group'
              )}
